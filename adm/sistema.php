...
if ($_SESSION['nivel'] == 1) {
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM usuarios WHERE id LIKE '%$data%' or loginn LIKE '%$data%' or senha LIKE '%$data%' ORDER BY id DESC";
    }
    else
    {
...
<body>
    ...
    <div class="box-search">
        <input type="search" class="form-control w-25" placeholder="Buscar" id="pesquisar">
        <button onclick="searchData()" class="btn" style="background-color:red";>
